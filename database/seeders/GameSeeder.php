...
class GameSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Game::insert([
            ...
            ['developer_id' => '4', 'title' => 'Fallout 4', 'description' => 'Post apoclyptic RPG', 'image' => 'fallout_4_cover.jpg','age_restriction' => '16', 'release_date' => '2012-11-12', 'created_at'=> $current_timestamp, 'updated_at', $current_timestamp],
