  ...
  @props(['title', 'image', 'description', 'release_date']) 
...
        <img src="{{ asset('images/games/' . $image) }}" alt="{{ $title }}" class="w-full max-w-xs h-auto object-cover"> <!-- Restrict image to max-w-xs (20rem) and ensure responsiveness --> 

    </div> 

    <!-- Publication Year --> 

    <h2 class="text-gray-500 text-sm italic mb-4" style="font-size: 1rem;">Published: {{ $release_date }}</h2> <!-- Emphasizing year with italics and smaller text --> 
